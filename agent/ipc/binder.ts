...
/*
    ...
    and
    https://github.com/Hamz-a/frida-android-libbinder/blob/master/frida_android_libbinder.js

    Binder is used for the inter process communication on Android. Therefore it is useful to monitor its traffic.

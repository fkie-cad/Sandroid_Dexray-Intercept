 ...
 *
 *************************************************************************************************/
import {PROXY_HOST, PROXY_PORT, CERT_PEM, DEBUG_MODE, IGNORED_NON_HTTP_PORTS, BLOCK_HTTP3, PROXY_SUPPORTS_SOCKS5, CERT_DER, MODULE_LOAD_CALLBACKS, waitForModule} from "./config_custom.js"

export function nativeTLSHook(){
    const TARGET_LIBS = [

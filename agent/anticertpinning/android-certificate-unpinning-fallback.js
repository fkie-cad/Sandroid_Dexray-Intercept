...
import {getCustomX509TrustManager, buildX509CertificateFromBytes} from "./android-certificate-unpinning.js"
import Java from "frida-java-bridge";

export function androidCertUnpinningFallback(){
                            ...
                            if (isOkHttpCheckMethod(errorMessage, failingMethod)) {
                                ...
                                if (
                                    ...
                                    failingMethod.implementation = (certs, authType) => {
                                        if (DEBUG_MODE) console.log(`[*] ACP: => Fallback X509TrustManager patch of ${
                                            className
                                        } base method`);
                                    ...
                                    if (DEBUG_MODE) console.log(`[*] ACP:[ ] Skipping unrecognized checkServerTrusted signature in class ${
